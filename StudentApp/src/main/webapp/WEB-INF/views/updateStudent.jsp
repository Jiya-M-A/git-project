			...
			<div class="card-body">
				<div class="container">
					...
					<form action="${pageContext.request.contextPath }/update"
						method="post">
						<input type="text" value="${students.id }" name="id">

						<div class="form-group">
							<label for="exampleInputEmail1">Name</label> <input type="text"
								class="form-control" id="exampleInputEmail1"
								aria-describedby="emailHelp" placeholder="Enter name"
								name="name" value="${students.name }">
						</div>

						<div>Gender</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="gender"
								id="inlineRadio1" value="${students.gender }"> <label
								class="form-check-label" for="inlineRadio1">Male</label>
						</div>
						<div class="form-check form-check-inline">
							<input class="form-check-input" type="radio" name="gender"
								id="inlineRadio2" value="Female" value="${students.gender }">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Favourite Subject </label> <input
								...
								aria-describedby="emailHelp" placeholder="Enter mark"
								name="favsub" value="${students.favsub }">
						</div>
